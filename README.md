...
| v0.28.0 | 292 | **Dependency refresh + documentation.** Node.js v24, vitest v4, junit-jupiter v6.1.2, jackson-databind v2.22.1, sqlite-jdbc v3.53.2.0, js-yaml v4.3.0, maven-surefire v3.5.6, actions/setup-java v5 — all CI and runtime dependencies updated. README + llms.txt updated: 291→292 manifest count, kcp-agent and kcp-harness added to ecosystem links, ecosystem overview updated to knowledge-layer-a-record (Jul 16 lineage post). `knowledge.yaml` refreshed: version 0.21→0.26, description updated for Phase B expansion, all unit validated dates refreshed. |
